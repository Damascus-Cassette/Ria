...
if __name__ is '__main__':
    async def scheduled_generator(task):
        i = 0
    ...
    async def scheduled_generator_exit_early(task):
        i = 0
        print('GENERATOR STARTING')
        try:
    ...
    async def main():
        ...
        b = Scheduled_Task(scheduled_generator)
        c = Scheduled_Task(scheduled_generator_exit_early)
